...
class TodayReportMohanondaDataModule extends ChangeNotifier {
  int rickshawVan;
  int motorCycle;
  ...
  TodayReportMohanondaDataModule({
    this.rickshawVan,
    this.motorCycle,
  ...
  TodayReportMohanondaDataModule.fromJson(Map<String, dynamic> json) {
