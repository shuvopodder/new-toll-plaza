...
class sevenDaysVipRowDesign extends StatefulWidget {
  String date;
  String total_amount;
  String rickshawvan;
  String motorcycle;
  ...
  sevenDaysVipRowDesign(
      {Key key,
        ...
        this.dividedColor});
  @override
  _sevenDaysVipRowDesignState createState() => _sevenDaysVipRowDesignState();
}

class _sevenDaysVipRowDesignState extends State<sevenDaysVipRowDesign> {
  String date;
  String total_amount;
  String rickshawvan;
  String motorcycle;
