...
class PreviousVipClassTeesta extends StatefulWidget {
  @override
  _PreviousVipClassTeestaState createState() => _PreviousVipClassTeestaState();
}

class _PreviousVipClassTeestaState extends State<PreviousVipClassTeesta> {
